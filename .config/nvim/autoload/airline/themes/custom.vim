...
" 8: cursorline
" 11: orange
let s:N1   = [ '#00005f' , '#dfff00' , 8, 2 ]
let s:N2   = [ '#ffffff' , '#444444' , 7, 8 ]
...
let g:airline#themes#custom#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 7, 8, ''],
      \ }


let s:I1 = [ '#00005f' , '#00dfff' , 8, 4 ]
let s:I2 = [ '#ffffff' , '#005fff' , 7, 8 ]
...
let s:IA1 = [ '#4e4e4e' , '#1c1c1c' , 7 , 8, '' ]
let s:IA2 = [ '#4e4e4e' , '#262626' , 7 , 8, '' ]
let s:IA3 = [ '#4e4e4e' , '#303030' , 7 , 8, '' ]
