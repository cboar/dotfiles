...
syn keyword   rustKeyword     in impl
...
syn region    rustAttribute   start="#!\?\[" end="\]" contains=rustFuncCall,GlobalCapital
...
syn keyword rustStorage let fn pub use
...
hi def link rustAttribute     Comment
