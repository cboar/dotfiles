...
syn keyword scalaUnderscore _ null
hi def link scalaUnderscore Special

syn match scalaFunction "\<\h\w*\>\(\s\|\n\)*("me=e-1
hi def link scalaFunction Function

syn keyword scalaKeyword catch do else final finally for forSome if new
...
syn keyword scalaKeyword case nextgroup=scalaKeyword skipwhite
syn keyword scalaValueDecl val def var
...
hi link scalaInstanceDeclaration scalaCapitalWord
...
hi link scalaTypeDeclaration scalaCapitalWord
hi link scalaTypeExtension Keyword
hi link scalaTypePostExtension Keyword

"syn match scalaTypeAnnotation /\%([_a-zA-Z0-9$\s]\_s*:\_s*\)\ze[_=(\.A-Za-z0-9$]\+/ skipwhite nextgroup=scalaTypeDeclaration contains=scalaRoundBrackets
